                  ...
                  return SizedBox(
                    ...
                    child: ElevatedButton(
                        onPressed: () async {
                          ...
                          if (result != null) {
                            final location = Location(name: result["name"],
                                iconName: result["iconName"]);
                            ref.read(settingPageProvider.notifier).addLocation(
                                location);
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          fixedSize: Size(
                              size.width / 2 - 20, (size.width / 2 - 20) / 2),
                          elevation: 10,
                        ...
                        child: const Center(child: Icon(
                            Icons.add, size: 50, color: Colors.orangeAccent))
                    ),
                  );
                }
                else {
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(builder: (context) =>
                                RegistrationListPage(locations[index - 1])),
                          );
                        },
                        style: ElevatedButton.styleFrom(
                          textStyle: const TextStyle(
